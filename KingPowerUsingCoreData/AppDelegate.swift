...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        print("the user default language is \(currentLanguage)")
        ...
        if((userDefaults.stringForKey("DEFAULTS_KEY_LANGUAGE_CODE")) == nil){
            ...
            let a = userDefaults.stringForKey("DEFAULTS_KEY_LANGUAGE_CODE")
            print("the user default language is \(a)")
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.ibm.mct.KingPowerUsingCoreData" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("KingPowerUsingCoreData", withExtension: "momd")!
