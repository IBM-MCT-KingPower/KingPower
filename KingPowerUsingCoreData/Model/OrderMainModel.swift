...
public class OrderMainModel{
    ...
    var queryUpdateOrderStatusById : String = "UPDATE ORDER_MAIN SET ORDM_ORDS_ID = %@, ORDM_UPDATE_DATE = %@ WHERE ORDM_ID = %@"
    
    var queryUpdateReceiptDepartureById : String = "UPDATE ORDER_MAIN SET ORDM_RECEIPT_DEPARTURE = '%@', ORDM_UPDATE_DATE = %@ WHERE ORDM_ID = %@"
    
    var queryUpdateReceiptArrivalById : String = "UPDATE ORDER_MAIN SET ORDM_RECEIPT_ARRIVAL = '%@', ORDM_UPDATE_DATE = %@ WHERE ORDM_ID = %@"
