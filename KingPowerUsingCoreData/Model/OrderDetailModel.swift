...
public class OrderDetailModel{
    ...
    var queryInsertOrderDetail : String = "INSERT INTO ORDER_DETAIL(ORDD_ORDM_ID, ORDD_PROD_ID, ORDD_QUANTITY, ORDD_TOTAL_PRICE, ORDD_REDEEM_ITEM, ORDD_PICKIP_NOW, ORDD_CREATE_DATE, ORDD_UPDATE_DATE) VALUES (%d, %d, %d, %@, '%@', '%@', %@, %@)"
