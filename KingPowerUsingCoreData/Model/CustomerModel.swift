...
public class CustomerModel{
    ...
    var queryGetCustomerByMemberId : String = "SELECT CUST_ID, CUST_TITLE, CUST_FIRST_NAME, CUST_LAST_NAME, CUST_GENDER, CUST_MEMBER_ID, CUST_CARD_ID, CUST_CARD_EXP_DATE, CUST_POINT, CUST_POINT_EXP_DATE, CUST_CREATE_DATE, CUST_UPDATE_DATE FROM CUSTOMER WHERE CUST_MEMBER_ID = '%@';"
