...
class ProductModel {
    ...
    var queryProductAll : String = "SELECT PROD_ID, PROD_CODE, PROD_NAME, PROD_TYPE, PROD_PRICE, PROD_DISCOUNT_PRICE, PROD_DESCRIPTION, PROD_DETAILS, PROD_REMARK, PROD_FLIGHT_ONLY, PROD_IN_STOCK, PROD_SALE, PROD_WEIGHT, PROD_HEIGHT, PROD_DEPTH, PROD_COLOR, PROD_GENDER, PROD_BRAN_ID, PROD_PRC_ID, PROD_RATING, PROD_CREATE_DATE, PROD_UPDATE_DATE FROM PRODUCT ORDER BY %@ %@;"
    var queryProductById : String = "SELECT PROD_ID, PROD_CODE, PROD_NAME, PROD_TYPE, PROD_PRICE, PROD_DISCOUNT_PRICE, PROD_DESCRIPTION, PROD_DETAILS, PROD_REMARK, PROD_FLIGHT_ONLY, PROD_IN_STOCK, PROD_SALE, PROD_WEIGHT, PROD_HEIGHT, PROD_DEPTH, PROD_COLOR, PROD_GENDER, PROD_BRAN_ID, PROD_PRC_ID, PROD_RATING, PROD_CREATE_DATE, PROD_UPDATE_DATE FROM PRODUCT WHERE PROD_ID = %@ ORDER BY %@ %@;"
    var queryProductByBrandId : String = "SELECT PROD_ID, PROD_CODE, PROD_NAME, PROD_TYPE, PROD_PRICE, PROD_DISCOUNT_PRICE, PROD_DESCRIPTION, PROD_DETAILS, PROD_REMARK, PROD_FLIGHT_ONLY, PROD_IN_STOCK, PROD_SALE, PROD_WEIGHT, PROD_HEIGHT, PROD_DEPTH, PROD_COLOR, PROD_GENDER, PROD_BRAN_ID, PROD_PRC_ID, PROD_RATING, PROD_CREATE_DATE, PROD_UPDATE_DATE FROM PRODUCT WHERE PROD_BRAN_ID = %@ ORDER BY %@ %@;"
    var queryProductByProductCategoryId : String = "SELECT PROD_ID, PROD_CODE, PROD_NAME, PROD_TYPE, PROD_PRICE, PROD_DISCOUNT_PRICE, PROD_DESCRIPTION, PROD_DETAILS, PROD_REMARK, PROD_FLIGHT_ONLY, PROD_IN_STOCK, PROD_SALE, PROD_WEIGHT, PROD_HEIGHT, PROD_DEPTH, PROD_COLOR, PROD_GENDER, PROD_BRAN_ID, PROD_PRC_ID, PROD_RATING, PROD_CREATE_DATE, PROD_UPDATE_DATE FROM PRODUCT WHERE PROD_PRC_ID = %@ ORDER BY %@ %@;"
    var queryProductByGender : String = "SELECT PROD_ID, PROD_CODE, PROD_NAME, PROD_TYPE, PROD_PRICE, PROD_DISCOUNT_PRICE, PROD_DESCRIPTION, PROD_DETAILS, PROD_REMARK, PROD_FLIGHT_ONLY, PROD_IN_STOCK, PROD_SALE, PROD_WEIGHT, PROD_HEIGHT, PROD_DEPTH, PROD_COLOR, PROD_GENDER, PROD_BRAN_ID, PROD_PRC_ID, PROD_RATING, PROD_CREATE_DATE, PROD_UPDATE_DATE FROM PRODUCT WHERE PROD_GENDER = %@ ORDER BY %@ %@;"
    var queryProductByProductGroupId : String = "SELECT PROD_ID, PROD_CODE, PROD_NAME, PROD_TYPE, PROD_PRICE, PROD_DISCOUNT_PRICE, PROD_DESCRIPTION, PROD_DETAILS, PROD_REMARK, PROD_FLIGHT_ONLY, PROD_IN_STOCK, PROD_SALE, PROD_WEIGHT, PROD_HEIGHT, PROD_DEPTH, PROD_COLOR, PROD_GENDER, PROD_BRAN_ID, PROD_PRC_ID, PROD_RATING, PROD_CREATE_DATE, PROD_UPDATE_DATE FROM PRODUCT JOIN PRODUCT_CATEGORY ON PROD_PRC_ID = PRC_ID JOIN PRODUCT_GROUP ON PRC_PROG_ID = PROG_ID WHERE PROG_ID = %@;"//ORDER BY %@ %@;"
