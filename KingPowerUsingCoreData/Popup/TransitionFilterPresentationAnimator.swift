...
class TransitionFilterPresentationAnimator: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(transitionContext: UIViewControllerContextTransitioning) {
        let toViewController = transitionContext.viewControllerForKey(UITransitionContextToViewControllerKey) as! detailFilterViewController
        ...
        toViewController.view.layer.shadowOffset = CGSizeMake(0.0, 1.0)
