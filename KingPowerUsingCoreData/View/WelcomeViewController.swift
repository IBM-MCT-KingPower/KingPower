...
class WelcomeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.birthdateLabel.text = dateFormatter.stringFromDate(self.customer.cust_birthdate)
        self.pointLabel.text = String(self.customer.cust_point)
        self.pointExpireDateLabel.text = dateFormatter.stringFromDate(self.customer.cust_point_exp_date)
        ...
        if(self.departFlight!.flii_id == 0){
            ...
            self.departDateLabel.text = dateFormatter.stringFromDate(self.departFlight!.flii_flight_date)
        }
        if(self.returnFlight!.flii_id == 0){
            ...
            self.returnDateLabel.text = dateFormatter.stringFromDate(self.returnFlight!.flii_flight_date)
        }
